...
import staticBanner from "../../assets/beautiful-shot-radio-tower-snowy-forest-background.jpg";
...
function getStatusMeta(status) {
  ...
  if (status === "stale") {
    return {
      label: "UUID mismatch",
      hint: "Selected station does not match this IP",
      Icon: FiAlertTriangle,
      statusClass: "status status-warning",
      badge:
        "badge badge-outline border-warning/30 text-warning bg-base-100/10 backdrop-blur-sm",
  ...
  return {
    label: "Inactive",
    hint: "Select a station to begin monitoring",
    Icon: FiSlash,
...
export default function DeviceStaticHeroBanner({
  status = "inactive",
  device = null,
  ...
  const locationText = useMemo(() => {
    if (!stationLocation?.lat || !stationLocation?.lon) {
      return "Location not set";
    }

    return `${Number(stationLocation.lat).toFixed(5)}, ${Number(
      stationLocation.lon,
    ).toFixed(5)}`;
  }, [stationLocation]);
  ...
  return (
    <section className="relative overflow-hidden rounded-box border border-base-300 bg-neutral text-neutral-content">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, rgba(10,12,18,0.97) 0%, rgba(10,12,18,0.91) 42%, rgba(10,12,18,0.55) 72%, rgba(10,12,18,0.18) 100%)",
        }}
      />
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(900px 380px at 20% 45%, rgba(34,197,94,0.13) 0%, rgba(34,197,94,0.00) 62%)",
          mixBlendMode: "screen",
          opacity: 0.9,
        }}
      />
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="min-w-0 max-w-3xl">
            <div className="flex items-center gap-2 text-xs sm:text-sm opacity-80">
              <span>Static Station Profile</span>
            </div>
            ...
            <div className="mt-1 max-w-2xl text-sm leading-6 text-neutral-content/75">
              Fixed-location environmental monitoring for temperature,
              humidity, pressure and air quality trends.
            </div>
            ...
            <div className="mt-4 grid gap-2 text-sm opacity-90">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="opacity-70">Station location:</span>
